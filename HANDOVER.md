...
- **Phase 7 (queued, not started):** supervised auto history-taking is
  spec'd in `PHASE_7_SPEC.md`. **Gate as of 2026-07-25:** the Phase 5
  precondition is satisfied (adjudication + fine-tune deferral), so what
  remains is `05_epigastric_pain_en`, Docker Compose packaging, and the
  two-role demo script. First commitment when it opens is 7a
